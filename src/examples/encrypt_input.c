...
int main() {
    ...
    uint8_t* output = bingenere_encrypt((uint8_t*)input, (uint8_t*)key);

    // print the encrypted data in hex and string format
    ...
    printf("\nAnd here's the encrypted data, represented as a string!\n");
    printf("%s\n", output);
